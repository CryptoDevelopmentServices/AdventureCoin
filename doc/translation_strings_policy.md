...
This document provides guidelines for internationalization of the Adventurecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `advc_en.ts` remains unchanged.
