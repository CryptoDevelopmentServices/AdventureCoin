Cross-compiliation of Adventurecoin Core
===============================

Adventurecoin Core can be cross-compiled on Linux to all other supported host systems. This is done by changing
the `HOST` parameter when building the dependencies and then specifying another `--prefix` directory when building Adventurecoin.
...
When building Adventurecoin Core, use
