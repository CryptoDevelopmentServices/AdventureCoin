...
* bitcoin.conf: contains configuration settings for adventurecoind or adventurecoin-qt
* adventurecoind.pid: stores the process id of adventurecoind while running
...
* debug.log: contains debug information and general logging generated by adventurecoind or adventurecoin-qt
