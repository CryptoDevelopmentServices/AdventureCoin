...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-prunedebuglogfile", _("Prune (limit) filesize of debug.log")); // FIXME.ADVC // prune debug.log
    if (showDebug)
    {
...
// FIXME.ADVC
// QT About Adventurecoin
std::string LicenseInfo()
{
    const std::string URL_SOURCE_CODE = "<https://github.com/adventurecoin-project/adventurecoin>";
    const std::string URL_WEBSITE = "<https://adventurecoin.org>";
...
void InitLogging()
{
    ...
    fPruneDebugLog = gArgs.GetBoolArg("-prunedebuglogfile", false); // FIXME.ADVC // prune debug.log
