...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 ADVC"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 ADVC"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 ADVC"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 ADVC"));
        ...
        labelBalance->setText(QString::fromUtf8("123.456 ADVC"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for AdventureCoin transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for AdventureCoin transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
