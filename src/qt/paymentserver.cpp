...
const char* BIP71_MIMETYPE_PAYMENT = "application/adventurecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/adventurecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/adventurecoin-paymentrequest";
