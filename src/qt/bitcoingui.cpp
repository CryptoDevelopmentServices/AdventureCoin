...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Adventurecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and advc: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Adventurecoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Adventurecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Adventurecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a advc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Adventurecoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Adventurecoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Adventurecoin Core"); // default title
    ...
    // Append title to "Adventurecoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
