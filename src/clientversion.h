...
//! These need to be macros, as clientversion.cpp's and advc*-res.rc's voodoo requires it
...
/**
 * advcd-res.rc includes this file, but it cannot cope with real c++ code.
